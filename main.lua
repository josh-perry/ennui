...
local function createLoginWindow()
    ...
    local formPanel = StackPanel()
        ...
        :setSpacing(12)
        :setSize(yui.Size.fixed(300), yui.Size.auto())
        :addChild(Text()
            :setText("Please enter your banks credentials")
            :setSize(yui.Size.fill(), yui.Size.auto())
        )
        :addChild(Text()
            :setText("Email:")
            :setSize(yui.Size.fill(), yui.Size.auto())
    ...
    local buttonRow = HorizontalStackPanel()
        :setSpacing(8)
        :setSize(yui.Size.fill(), 40)

    buttonRow:addChild(
        TextButton()
            :setText("Login")
            :setSize(yui.Size.fill(), yui.Size.fill())
...
local function createNestedLayoutExample()
    local GridLayoutStrategy = require("yui.layout.grid_layout_strategy")
    ...
    local buttonGrid = Widget()
        :setSize(yui.Size.fill(), 120)
        :setLayoutStrategy(GridLayoutStrategy(3, 3)
        :setSpacing(8))
...
local function createReactivePropertiesExample()
    ...
    local function addDisplayGrid()
        ...
        local gridContainer = Widget()
            :setSize(yui.Size.fill(), yui.Size.auto())
            :setLayoutStrategy(GridLayoutStrategy(2, 2)
            :setSpacing(8))

        gridContainer:addChild(
            Text()
                :setText("Double it:")
                :setSize(yui.Size.fill(), 24)
    ...
    panel:addChild(Widget()
        :setSize(yui.Size.fill(), yui.Size.auto())
        :setLayoutStrategy(GridLayoutStrategy(2, 1)
        :setSpacing(8))
        :addChild(Text()
...
local function createTextButtonWithImageExample()
    local OverlayLayoutStrategy = require("yui.layout.overlay_layout_strategy")
    ...
    local button = Button()
        ...
        :setLayoutStrategy(OverlayLayoutStrategy())
        :setPadding(16)
        :setMargin(16)
        :onClick(function()
